        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="inline-flex items-center rounded-full border px-4 py-1.5 text-sm font-medium bg-background">
              ...
              <span>24/7 Police Assistance</span>
            </div>

            <h1 className="text-4xl md:text-5xl font-bold tracking-tight">
              Your Digital Bridge to <span className="text-police-600 dark:text-police-400">Police Services</span>
            </h1>

            <p className="text-lg text-muted-foreground">
              Get instant information about police procedures, complaint filing, emergency contacts, and legal
              provisions without visiting a police station.
            </p>
          ...
          <div className="relative">
            ...
            <div className="relative bg-card rounded-xl shadow-xl overflow-hidden border">
              <div className="p-4 bg-police-600 text-white flex items-center gap-2">
                ...
                <h3 className="font-medium">CopBotChatbox</h3>
              </div>
